...
class DatabaseManager:
    ...
    def get_prize_img(self, prize_id):
        ...
        with conn:
            cur = conn.cursor()
            cur.execute('SELECT prize_id FROM prizes')
    ...
    def get_random_prize(self):
        ...
        with conn:
            cur = conn.cursor()
            cur.execute('SELECT prize_id, image FROM prizes ORDER BY RANDOM() LIMIT 1 ')
...
if __name__ == '__main__':
    ...
    prizes_img = os.listdir('C:/Linked/Python/new projct/TTT/img')
